...
export default function AboutPage() {
  return <main><SiteHeader />
    <section className="about-hero"><Image src="https://hiddenchinatravel.com/assets/blog/dali-hidden-gems-off-the-beaten-path/xizhou-bai-courtyard.webp" alt="A traditional Bai courtyard in Xizhou, Yunnan" fill priority sizes="100vw" /><div className="hero-shade" /><div><p className="kicker">ABOUT HIDDEN CHINA TRAVEL</p><h1>Born in Yunnan. Shaped by experiences abroad.</h1></div></section>
    ...
    <section className="responsible"><div className="shell responsible-grid"><div><p className="kicker">OUR COMMITMENT</p><h2>Less filling the itinerary. More enjoying the journey.</h2><p>No forced shopping stops, commission-based detours or tourist factories disguised as cultural experiences. We prioritize what we would genuinely recommend to friends and family.</p><p>If something is not worth your time, we will say so—even when that means recommending less. Slower, realistic routes are often better for the traveler and leave more room for local people and businesses.</p></div><div className="responsible-image"><Image src="https://hiddenchinatravel.com/assets/blog/dali-hidden-gems-off-the-beaten-path/weishan-xinggong-tower.webp" alt="Historic Xinggong Tower in Weishan" fill sizes="(max-width: 800px) 100vw, 42vw" /></div></div></section>
