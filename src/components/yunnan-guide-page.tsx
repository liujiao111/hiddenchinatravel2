...
export function YunnanGuidePage({ journey }: { journey: Journey }) {
  ...
  return <main>
    ...
    <nav className="yunnan-anchor-nav" aria-label="On this page"><div className="shell"><Link href="#plan">Plan</Link><Link href="#places">Places</Link><Link href="#route">Route</Link><Link href="#guides">Dali guides</Link><Link href="#season">Season</Link><Link href="#prepare">Prepare</Link><Link href="#faq">FAQ</Link></div></nav>
