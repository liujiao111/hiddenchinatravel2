...
const menuGroups: Record<Exclude<MenuName, "destinations">, { title: string; links: string[] }[]> = {
  journeys: [
    { title: "Travel your way", links: ["Private journeys", "Slow-paced travel", "First trip to China", "Family journeys"] },
    { title: "Yunnan ideas", links: ["Dali at an unhurried pace", "Dali & Shaxi", "Villages and local craft", "Build your own route"] },
    { title: "Local support", links: ["English-speaking guides", "Private drivers", "Route planning", "Help while you travel"] },
  ],
  guides: [
